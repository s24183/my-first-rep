...
/**
	...
	public String toString() {
		return "(Amount) " + amount + " (CurrencyName) " + currency.getName() ;
	}
...
*/
	...
	public Money add(Money other) {
		int addAmount = (int) (amount + other.universalValue()/currency.getRate());

		return new Money(addAmount, this.currency);
...
*/
	...
	public Money sub(Money other) {
		int subAmount = (int) (amount - other.universalValue()/currency.getRate());
...
/**
	...
	public int compareTo(Object other) {
		Money others = (Money) other;
		return Integer.compare(this.universalValue(), others.universalValue());
	}
}
